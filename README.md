# Seedream 5.0 Pro API (seedream-5.0 / seedream5.0) — api guide with published pricing
...
**[Live pricing](https://go.apimart.ai/k-c045f1)** · **[Get an API key](https://go.apimart.ai/k-796b5b)**
